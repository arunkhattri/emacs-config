...
#+BEGIN_SRC emacs-lisp
  ...
  ;; package: ws-butler
  ;; helps managing whitespace on every line of code written or edited, in an
  ;; unobtrusive, help you write clean code without noisy whitespace effortlessly
